...
Rails.application.configure do
  ...
  config.action_cable.url = 'ws://sharescription.herokuapp.com/cable'
  config.action_cable.allowed_request_origins = ['http://sharescription.herokuapp.com',
                                                 %r{/http:\/\/sharescription.herokuapp.*/}]
